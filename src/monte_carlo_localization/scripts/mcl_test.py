...
# ------------------------------------------------------------------
# Summary:
# Example of implementation of monte carlo localization (particle) filter class on a simple Two-Wheeled Robot system defined by
...
if __name__ == "__main__":
    ...
    for i in range(int(twr.t_end/twr.dt)):
        # truth model updates
        twr.Propagate()
        mcl.Propogate(twr.Getu(), twr.Getz())
